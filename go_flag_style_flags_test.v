...
fn test_go_flag_style() {
	prefs, _ := flags.to_struct[Prefs](exe_and_go_flag_args, skip: 1, style: .go_flag)!
	assert prefs.flag
...
fn test_go_flag_style_no_exe() {
	prefs, _ := flags.to_struct[Prefs](exe_and_go_flag_args[1..], style: .go_flag)!
	assert prefs.flag
	assert prefs.flag_value == 'ok'
	assert prefs.version
	assert prefs.is_live
...
fn test_go_flag_style_with_tail() {
	prefs, _ := flags.to_struct[Prefs](exe_and_go_flag_args_with_tail, skip: 1, style: .go_flag)!
	assert prefs.flag
	assert prefs.flag_value == 'ok'
	assert prefs.version
	assert prefs.is_live
...
fn test_go_flag_style_with_tail_no_exe() {
	prefs, _ := flags.to_struct[Prefs](exe_and_go_flag_args_with_tail[1..], style: .go_flag)!
	assert prefs.flag
	assert prefs.flag_value == 'ok'
	assert prefs.version
	assert prefs.is_live
